...
docker push  nikhil609651/multi-client:latest
docker push  nikhil609651/multi-server:latest
docker push  nikhil609651/multi-worker:latest
docker push  nikhil609651/multi-client:$SHA
docker push  nikhil609651/multi-server:$SHA
docker push  nikhil609651/multi-worker:$SHA
kubectl apply -f k8s
