docker build -t nikhil609651/multi-client:latest -t nikhil609651/multi-client:$SHA -t ./client/Dockerfile ./client
docker build -t nikhil609651/multi-server:latest -t nikhil609651/multi-server:$SHA -t ./server/Dockerfile ./server
docker build -t nikhil609651/multi-worker:latest -t nikhil609651/multi-worker:$SHA -t ./worker/Dockerfile ./worker
